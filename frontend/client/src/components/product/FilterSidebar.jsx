...
const FilterSidebar = () => {
  ...
  const materials = ["Cotton", "Wool", "Denim", "Polyester", "Silk", "Linem", "Viscose", "Fleece"];
  ...
  const handleFilterChange = (e) => {
      ...
      if(type === "checkbox"){
        ...
        else newFilters[name] = newFilters[name].filte((item) => item !== value);
      }else{
...
navigate(`?${params.toString()}`);   //category=Top+Wear&size=XS%2CX   (%2CS - ,)
  };
